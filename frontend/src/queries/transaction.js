...
const useTransactionsGet = ({firstDate, lastDate, category, dateSort, priceSort, skip, take, key}) => useQuery(
    key, () => getTrs({firstDate, lastDate, category, dateSort, priceSort, skip, take, key}), 
    {refetchOnWindowFocus: false, enabled: false, keepPreviousData: true,}
);
